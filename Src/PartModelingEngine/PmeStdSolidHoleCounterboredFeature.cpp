...
void PmeStdSolidHoleCounterboredFeature::AttachName_pointbased(BODY *& pBody)
{	
...
void PmeStdSolidHoleCounterboredFeature::NamingNewVertices_pointbased(BODY *& pPatternBody)
{
	ENTITY_LIST edge_list;
...
void PmeStdSolidHoleCounterboredFeature::AttachFaceName_pointbased(BODY *& pPatternBody)
{	
	FACE * ff ;
