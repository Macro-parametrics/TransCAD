...
PmeStdSolidCutRevolveFeature::~PmeStdSolidCutRevolveFeature(void)
{
}

void PmeStdSolidCutRevolveFeature::Update(void)
{
...
void PmeStdSolidCutRevolveFeature::Transform(const SPAtransf & transformation, BODY *& pBody)
{
	pBody = 0;
...
bool PmeStdSolidCutRevolveFeature::IsCut(void)
{
	return true;
}

void PmeStdSolidCutRevolveFeature::CreateSolidBody(BODY *& pBody)
{
