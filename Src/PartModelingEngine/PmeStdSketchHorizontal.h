...
{
	PME_DECLARE_RUNTIME_TYPE(PmeStdSketchHorizontal)
public:
	PmeStdSketchHorizontal(PmeStdSketchFeature * pSketchFeature, PmeReference * pTarget);
	virtual ~PmeStdSketchHorizontal(void);
	...
	virtual PmeStdSketchConstraintType GetType(void) const {return PmeStdSketchConstraintType_Horizontal;}
