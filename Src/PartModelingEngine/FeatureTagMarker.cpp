#include "stdAfx.h"
#include "FeatureTagMarker.h"
#include "PmeFeature.h"

#define ATTRIB_NAME "FEATURE"

void FeatureTagMarker::Attach(BODY * pBody, PmeFeature * pFeature)
{
	ENTITY_LIST faces;
...
void FeatureTagMarker::Attach(FACE * pFace, PmeFeature * pFeature)
{
	api_add_generic_named_attribute(pFace, ATTRIB_NAME, (int)(pFeature), SplitCopy, MergeKeepAll);
}

PmeFeature * FeatureTagMarker::FindFeature(ENTITY * pEntity)
{
...
void FeatureTagMarker::Detach(FACE * pFace)
{
...
void FeatureTagMarker::Clear(ENTITY * pEntity)
{
	ENTITY_LIST faces;
