...
void AssemImUtility::RegisterCallbacks()
{
	HImRegisterCallback("AssemImUtility_DatumPlaneCallback", DatumPlaneCallback);
}

void AssemImUtility::ScaleIndependentSegment(HIC_Rendition * nr, HIC_Segment_Info * si, float scale)
{
...
void AssemImUtility::DatumPlaneCallback(HIC_Rendition * nr, HIC_Segment_Info * si)
{
	ScaleIndependentSegment(nr, si, 50.0);
}