...
#if !defined(__ASSEM_SIZECBAR_H__)
#define __ASSEM_SIZECBAR_H__
...
/////////////////////////////////////////////////////////////////////////
// CAssemSCBDockBar dummy class for access to protected members

class CAssemSCBDockBar : public CDockBar
{
    friend class CAssemSizingControlBar;
};

/////////////////////////////////////////////////////////////////////////
// CAssemSizingControlBar control bar styles
...
/////////////////////////////////////////////////////////////////////////
// CAssemSizingControlBar control bar

#ifndef baseCSizingControlBar
#define baseCSizingControlBar CControlBar
#endif

class CAssemSizingControlBar;
typedef CTypedPtrArray <CPtrArray, CAssemSizingControlBar*> CAssemSCBArray;

class CAssemSizingControlBar : public baseCSizingControlBar
{
    DECLARE_DYNAMIC(CAssemSizingControlBar);
...
public:
    ...
    //{{AFX_VIRTUAL(CAssemSizingControlBar)
    public:
...
// Implementation
public:
    virtual ~CAssemSizingControlBar();
...
protected:
    ...
    void GetRowSizingBars(CAssemSCBArray& arrSCBars);
    void GetRowSizingBars(CAssemSCBArray& arrSCBars, int& nThis);
...
protected:
    //{{AFX_MSG(CAssemSizingControlBar)
...
// Implementation
public:
    CAssemSizingControlBar* GetSizingControlBar();
