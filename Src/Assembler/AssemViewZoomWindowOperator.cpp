...
AssemViewZoomWindowOperator::AssemViewZoomWindowOperator(HBaseView * view, int DoRepeat, int DoCapture)
 : HOpCameraZoomBox(view, DoRepeat, DoCapture)
{
	m_bIsPrevRenderMode = false;
}

AssemViewZoomWindowOperator::~AssemViewZoomWindowOperator(void)
{
}

int AssemViewZoomWindowOperator::OnLButtonUp(HEventInfo & event)
{
...
int AssemViewZoomWindowOperator::OnLButtonDblClk(HEventInfo & event)
{
