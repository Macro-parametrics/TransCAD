// AssemApplyPerpendicularDialog.cpp : 구현 파일입니다.
//

#include "stdafx.h"
#include "AssemApplyPerpendicularDialog.h"
#include "..\PartModelingEngine\PmeStdAssemblyPerpendicularAPI.h"
...
// AssemApplyPerpendicularDialog 대화 상자입니다.

IMPLEMENT_DYNAMIC(AssemApplyPerpendicularDialog, AssemApplyConstraintDialog)

AssemApplyPerpendicularDialog::AssemApplyPerpendicularDialog( AssemView * pView, CWnd* pParent /*=NULL*/ )
	: AssemApplyConstraintDialog( pView )
{
	m_selectPart = 0;
}

AssemApplyPerpendicularDialog::~AssemApplyPerpendicularDialog()
{
}

void AssemApplyPerpendicularDialog::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(AssemApplyPerpendicularDialog, AssemApplyConstraintDialog)
	ON_CBN_SELCHANGE(IDC_CONSTRAINED_GEOM_TYPE, &AssemApplyPerpendicularDialog::OnCbnSelchangeConstrainedGeomType)
	ON_CBN_SELCHANGE(IDC_REFERENCE_GEOM_TYPE, &AssemApplyPerpendicularDialog::OnCbnSelchangeReferenceGeomType)
END_MESSAGE_MAP()


BOOL AssemApplyPerpendicularDialog::OnInitDialog()
{
	CDialog::OnInitDialog();

	m_constraintName.SetWindowText( GetNewConstraintName( PmeStdAssemblyConstraintType_Perpendicular ) );
...
void AssemApplyPerpendicularDialog::OnCbnSelchangeConstrainedGeomType()
{
	m_selectPart = 0;
...
void AssemApplyPerpendicularDialog::OnCbnSelchangeReferenceGeomType()
{
	m_selectPart = 1;
...
bool AssemApplyPerpendicularDialog::ApplyConstraint()
{
...
/******************** 입력 값의 유효성 판단 종료 ********************/
	...
	bool result = PmeStdAssemblyPerpendicularAPI::ApplyPerpendicular( m_hAssembly,
																	  _constraintName,
																	  _hConstrainedPart,
