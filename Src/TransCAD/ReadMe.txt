================================================================================
              MFC 라이브러리 : TransCAD 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 TransCAD 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 TransCAD 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.
...
TransCAD.h
    ...
    특정 헤더가 포함되며 TransCADApp 응용 프로그램 클래스가 선언됩니다.

TransCAD.cpp
    TransCADApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
res\TransCAD.ico
    ...
    이 아이콘은 주 리소스 파일인 TransCAD.rc에 포함됩니다.
...
MainFrame.h, MainFrame.cpp
    MainFrame 프레임 클래스를 포함하는 파일입니다.
    프레임 클래스는 CMDIFrameWnd에서 파생되며 모든 MDI 프레임 기능을 제어합니다.
res\Toolbar.bmp
    도구 모음에 바둑판식 이미지를 만들 때 사용되는 비트맵 파일입니다.
    초기 도구 모음 및 상태 표시줄은 MainFrame 클래스에 구성됩니다.
    리소스 편집기를 사용하여 도구 모음 비트맵을 편집하고 TransCAD.rc의
...
ChildFrm.h, ChildFrm.cpp
    PartFrame 클래스를 정의하고 구현하는 파일로서 MDI 응용 프로그램에서
    자식 창을 지원합니다.
...
PartDocument.h, PartDocument.cpp - 문서
    PartDocument 클래스를 포함하는 파일입니다. 이 파일을 편집하여
    특정 문서 데이터를 추가하고 파일을 저장 및 로드합니다
    (PartDocument::Serialize 사용).
PartView.h, PartView.cpp - 문서 뷰
    PartView 클래스를 포함하는 파일입니다.
    PartView 개체를 사용하여 PartDocument 개체를 볼 수 있습니다.
res\TransCADDoc.ico
    PartDocument 클래스의 MDI 자식 창의 아이콘으로 사용되는 아이콘 파일입니다.
    이 아이콘은 주 리소스 파일인 TransCAD.rc에 포함됩니다.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) TransCAD.pch 및 미리 컴파일된
